...
func (ec *executionContext) field_Mutation_createUser_argsUser(
	...
	if tmp, ok := rawArgs["user"]; ok {
		return ec.unmarshalNUserInput2githubᚗcomᚋevitarafadigaᚋgoᚑgraphᚋmodelᚐUserInput(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_updateUser_argsUser(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("user"))
	if tmp, ok := rawArgs["user"]; ok {
		return ec.unmarshalOUserInput2ᚖgithubᚗcomᚋevitarafadigaᚋgoᚑgraphᚋmodelᚐUserInput(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_createUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNUser2ᚖgithubᚗcomᚋevitarafadigaᚋgoᚑgraphᚋmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_users(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.User)
	fc.Result = res
	return ec.marshalNUser2ᚕᚖgithubᚗcomᚋevitarafadigaᚋgoᚑgraphᚋmodelᚐUserᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNUser2githubᚗcomᚋevitarafadigaᚋgoᚑgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v model.User) graphql.Marshaler {
	return ec._User(ctx, sel, &v)
}

func (ec *executionContext) marshalNUser2ᚕᚖgithubᚗcomᚋevitarafadigaᚋgoᚑgraphᚋmodelᚐUserᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.User) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNUser2ᚖgithubᚗcomᚋevitarafadigaᚋgoᚑgraphᚋmodelᚐUser(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNUser2ᚖgithubᚗcomᚋevitarafadigaᚋgoᚑgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNUserInput2githubᚗcomᚋevitarafadigaᚋgoᚑgraphᚋmodelᚐUserInput(ctx context.Context, v any) (model.UserInput, error) {
...
func (ec *executionContext) unmarshalOUserInput2ᚖgithubᚗcomᚋevitarafadigaᚋgoᚑgraphᚋmodelᚐUserInput(ctx context.Context, v any) (*model.UserInput, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalInputUserInput(ctx, v)
